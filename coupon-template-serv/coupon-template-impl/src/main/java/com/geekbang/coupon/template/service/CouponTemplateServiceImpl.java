...
public class CouponTemplateServiceImpl  implements CouponTemplateService {
    ...
    public PagedCouponTemplateInfo search(TemplateSearchParams request) {
        ...
        Page<CouponTemplate> result = templateDao.findAll(Example.of(couponTemplate),pageable);
        List<CouponTemplateInfo> list = result.stream()
        ...
        PagedCouponTemplateInfo response = PagedCouponTemplateInfo.builder()
                ...
                .total(request.getPageSize()).build();
        return response;
    }
    ...
    @Override
    public void saveCouponTemplate(CouponTemplate info) {

        templateDao.save(info);
    }
